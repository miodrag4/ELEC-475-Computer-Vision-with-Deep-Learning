...
def main():
    # Set device (CPU or GPU) for training, "cuda"
    ...
    # Load and preprocess the MNIST dataset , Step 2
    ...
    # Train the model
    losses_train = train_model(num_epochs, optimizer, model, loss_fn, train_loader, scheduler, device)
